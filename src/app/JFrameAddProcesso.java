...
public class JFrameAddProcesso extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {
        /*
         * Processo processo = new Processo(txtNome.getText().toString(),
         * (int)spinnerPrioridade.getValue(), (int)spinnerCiclos.getValue());
         * main.escalonador.addProcesso(processo); main.atualizar();
         */
    }
